...
fps_p = os.path.join(prj_dir, 'BITE_AHAP_selection2020jan14.shp')# Alternative to providing danco DB, provide a shapfile of footprints
...
def grid_aoi(aoi_shp, step):
    ...
    Parameters
    ----------
    aoi_shp : os.path.abspath
        Path to shapefile AOI.
    step : FLOAT
