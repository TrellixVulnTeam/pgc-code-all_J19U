...
count = count_table(danco_lyr, where=where, table=True)
...
while offset < count:
    ...
    # Load footprints
    fps = query_footprint(danco_lyr, where=where, limit=limit, offset=offset)
...
usfs_fps_catids = list(usfs_fps['catalogid'])
#%%
# Remove onhand IDs
oh = onhand_ids()
